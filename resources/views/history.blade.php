...
<style>
                ...
                <nav class="px-4 py-4 mt-5 lg:mt-9 lg:px-6" x-data="{ selected: $persist('Dashboard') }">
                    <div>
                        ...
                        <ul class="mb-6 flex flex-col gap-1.5">
                            ...
                            <li>
                                <a class="active_item group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-gray-500 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                    ...
                    <div class="flex flex-col gap-3 mb-6 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <nav>
                            <ol class="flex items-center gap-2">
                                ...
                                <li class="font-medium text-primary">Tasks history</li>
                            </ol>
                        </nav>
                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="show_task">
                                        <ul class="p-5 list_tasks">
                                            <header class="w-full h-10 grid-cols-3 text-center ">
                                                <span class="flex justify-center align-middle task_items_w ">Title</span>
                                                <span class="flex justify-center align-middle task_items_w">Description</span> 
                                                <span class="flex justify-center align-middle task_items_w">Status</span>
                                                <span class="flex justify-center align-middle task_items_w"></span>
                                            </header>
                                            <hr>
   ...
   fetch('http://127.0.0.1:8000/api/getTask/'+email+''
   ...
   .then(data => {
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        li.setAttribute('class', 'w-full   h-[2.5em]  border-b-2 border-gray-500'); 
        list_task.appendChild(li);
        var span1 = document.createElement('span');
        span1.setAttribute('class', 'task_items_w  text-center '); 
        span1.textContent=data[i]['title'];
        li.appendChild(span1);
        

        var span2 = document.createElement('span');
        span2.setAttribute('class', 'task_items_w text-center'); 
        ...
        span3.setAttribute('class', 'task_items_w text-center h-[1.5em] '); 
        ...
        var delete_btn = document.createElement('botton');
        delete_btn.setAttribute('class', 'btn text-black cursor-pointer task_items_w text-center'); 
