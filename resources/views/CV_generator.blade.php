        ...
        <div class="w-full flex-row  flex justify-center absolute  top-[6em] text-white">
            ...
            <form action="" method="post"
                ...
                <input type="text"
                    ...
                    class="text-red-400 relative bottom-[2.2em] left-[46em]">*</span>
                <button type="button"
                    class="p-2 my-2 bg-blue-400 rounded-lg focus:outline-none hover:bg-blue-700 hover:text-white">Add
                    new language</button>
                ...
                <input type="number"
                    class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black"
                    placeholder="How many percent do you know?" required name="skill_value" id="skill_value"><span
                    class="text-red-400 relative bottom-[2.2em] left-[46em]">*</span>
                <button type="button"
                    class="p-2 my-2 bg-blue-400 rounded-lg focus:outline-none hover:bg-blue-700 hover:text-white">Add
                    new skill</button>
