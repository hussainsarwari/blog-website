        ...
        <div class="flex justify-between p-3 bg-blue-300 col d-none d-md-flex">
            ...
            <div class="flex flex-row ">
                <form action="" method="post" class="flex flex-row mx-5 search">
                    @csrf
                    <input class=" p-1 mx-2 text3white bg-blue-300 border-b border-blue-500 graye-no focus:bg-blue-100  ne focus:outline-none focus:bg-blue-400 placeholder:text-white" placeholder="Search" type="search" name="search" required id="search">
                    <button type="submit">
                            ...
                            <div class="">
                                ...
                                <li class="px-3 py-2 text-white cursor-pointer scroll-to-section peer new-ite active" id="blog"  style="padding: 10px 20px;  color: white; border: none; cursor: pointer;" >Tools</li>
                                    ...
                                    <div class="fixed flex-col hidden p-4 mt-0 bg-white shadow-lg download rounded-xl peer-hover:flex hover:flex h-fit">
                                        ...
                                        <a class="px-1 w-[15em] text-center py-2 text-black hover:bg-gray-300 hover:text-white" href="{{url('')}}">Short URL</a>
...
<div class="rounded-full w-[8em] h-8em md:w-[30em] md:h-[30em] bg-yellow-300 absolute top-[60em] md:top-[50em] left-0 md:left-10 shadow-2xl shadow-yellow-500 box1"></div>

    {{-- main section --}}
    <div class="relative w-full h-screen mb-20 " >
        <div class="w-[55em] h-[55em] lg:w-[80em] lg:h-[80em] bg-blue-500 shadow-2xl shadow-blue-600 absolute top-[-18em] right-[5em] rounded-full "></div>
        <div class="w-full flex-row  flex justify-center absolute  top-[6em] text-white">
           

            <h1 class="w-full  flex justify-center absolute  text-sm lg:text-3xl top-16 lg:top-[6em] text-white">Create your CV just in one minute</h1>
            <form action="" method="post" class=" overflow-x-hidden flex flex-col justify-center mx-5 search bg-slate-50 shadow-2xl shadow-slate-500 rounded-lg py-5 p-4 z-50 w-[30em] md:w-[50em] relative top-[20em] cv-generator" >
                    @csrf
                    <p class=" text-center text-sm md:text-lg my-3 text-gray-400 font-bold font-sans">personal information(Required) <hr></p>

                <input class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black"  placeholder="name" type="text" name="name" required id="name"><span class="text-red-400 relative bottom-[2.2em] left-[46em]">*</span>
             
                <input class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black"  placeholder="Last name" type="text" name="lastname" required id="lastname"><span class="text-red-400 relative bottom-[2.2em] left-[46em]">*</span>
                <input class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black"  placeholder="Email" type="email" name="email" required id="email"><span class="text-red-400 relative bottom-[2.2em] left-[46em]">*</span>
                <input class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black"  placeholder="Phone number" type="number" name="phone_number" required id="phone_number"><span class="text-red-400 relative bottom-[2.2em] left-[46em]">*</span>
                <input class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black"  placeholder="Github" type="text" name="github"  id="github">
                <input class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black"  placeholder="website" type="text" name="website"  id="website">
                <input class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black"  placeholder=" Title" type="text" name="title" required id="title"><span class="text-red-400 relative bottom-[2.2em] left-[46em]">*</span>
                {{-- education  --}}
                <div class="education">

                    <p class=" text-center text-sm md:text-lg my-3 text-gray-400 font-bold font-sans">Education Section(Required) <hr></p>
                    <input class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black"  placeholder="educational background" type="text" name="education" required id="education"><span class="text-red-400 relative bottom-[2.2em] left-[46em]">*</span>
                    <input class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black"  placeholder="educational background start date" type="date" name="educational_start" required id="educational_start"><span class="text-red-400 relative bottom-[2.2em] left-[44.5em]">*</span>
                    <input class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black"  placeholder="educational background end date" type="date" name="education_end"  id="education_end">
                    <label for="education_date" class="text-black">It is going on:
                        <input class=" w-10   border border-spacing-1 border-blue-300"  type="checkbox" name="education_date"  id="education_date">
                    </label>
                </div>
                    <button type="button"   class="remove_edu focus:outline-none border-2  text-black border-red-400 p-2 rounded-lg my-2 hover:bg-red-400 hover:text-white hidden">Remove</button>
                    <button type="button"   class="add_edu focus:outline-none bg-blue-400 p-2 rounded-lg my-2 hover:bg-blue-700 hover:text-white">Add new educational background</button>
                {{-- Certificates  --}}
                <div class="certificate">

                    <p class=" text-center text-sm md:text-lg my-3 text-gray-400 font-bold font-sans">Certificates Section (Optional) <hr></p>
                    <input class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black"  placeholder="Certificate Title" type="text" name="certificate"  id="certificate">
                    <input class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black"  placeholder="More information" type="text" name="certificate_information"  id="certificate_information">
                </div>
                <button type="button"   class=" focus:outline-none border-2  text-black border-red-400 p-2 rounded-lg my-2 hover:bg-red-400 hover:text-white hidden btn_remove_certificate">Remove</button>
                  
                <button type="button" class="focus:outline-none bg-blue-400 p-2 rounded-lg my-2 hover:bg-blue-700 hover:text-white btn_add_certificate">Add new Certificate</button>
              {{-- experince  --}}
              <p class=" text-center text-sm md:text-lg my-3 text-gray-400 font-bold font-sans">Experince Section(Required) <hr>/p>
                <input class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black" required placeholder="work experince" type="text" name="experince"  id="experince"><span class="text-red-400 relative bottom-[2.2em] left-[46em]">*</span>
                <input class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black" required placeholder="work experince start date" type="date" name="experince_start"  id="experince_start"><span class="text-red-400 relative bottom-[2.2em] left-[44.5em]">*</span>
                <input class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black" required placeholder="work experince end date" type="date" name="experince_end"  id="experince_end">
                ...
                <button type="button" class="focus:outline-none bg-blue-400 p-2 rounded-lg my-2 hover:bg-blue-700 hover:text-white">Add new work experince</button>
               
                {{-- languages --}}
                <p class=" text-center text-sm md:text-lg my-3 text-gray-400 font-bold font-sans">Language Section(Required) <hr></p>

                    <input type="text" class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black" placeholder="Language" required name="language" id="language"><span class="text-red-400 relative bottom-[2.2em] left-[46em]">*</span>
                    <input type="text" class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black" placeholder="Writting" required name="language_writting" id="language_writing"><span class="text-red-400 relative bottom-[2.2em] left-[46em]">*</span>
                    <input type="text" class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black" placeholder="Speaking" required name="language_speaking" id="language_speaking"><span class="text-red-400 relative bottom-[2.2em] left-[46em]">*</span>
                    <input type="text" class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black" placeholder="Listning" required name="language_listning" id="language_listning"><span class="text-red-400 relative bottom-[2.2em] left-[46em]">*</span>
                    <button type="button" class="focus:outline-none bg-blue-400 p-2 rounded-lg my-2 hover:bg-blue-700 hover:text-white">Add new language</button>

                {{-- skills --}}
                <p class=" text-center text-sm md:text-lg my-3 text-gray-400 font-bold font-sans">Skill Section(Required) <hr></p>
                <input type="text" class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black" placeholder="write your skill" required name="skill" id="skill"><span class="text-red-400 relative bottom-[2.2em] left-[46em]">*</span>
                <input type="number" class=" my-2 w-full h-[3em] text-sm md:text-md border-b-2 border-b-gray-500 focus:bg-blue-100   p-2 focus:outline-none text-black" placeholder="How many percent do you know?" required name="skill_value" id="skill_value"><span class="text-red-400 relative bottom-[2.2em] left-[46em]">*</span>
                <button type="button" class="focus:outline-none bg-blue-400 p-2 rounded-lg my-2 hover:bg-blue-700 hover:text-white">Add new skill</button>
               
                <button type="submit" class="focus:outline-none bg-blue-400 p-2 rounded-lg my-2 hover:bg-blue-700 hover:text-white">
                Create my CV
                </button>
            </form>
        </div>
      ...
      <div class="py-4 row">
          ...
          <div class="mb-4 col-6 col-lg-2 mb-lg-0">
              ...
              <ul class="list-unstyled">
                             ...
                             <li class="mb-0">
                              ...
                              <a class="text-sm text-white lg:text-md text-decoration-none" href="{{url('')}}">Short URL</a></li> <li class="mb-0">
          ...
          <div class="col-12 col-lg-3">
              ...
              <div class="mb-2 input-group">
                  <input class=" text-sm form-cont3ol bg-light lg:text-md" placeholder="Email graydres focus:bg-blue-100  s" type="text"> <button class="btn btn-primary" type="button">Subscribe</button>
              </div>
