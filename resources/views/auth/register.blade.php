...
@section('content')
    ...
    <div class="flex h-screen overflow-hidden register">
                    ...
                    <div>
                        ...
                        <ul class="my-6 flex flex-col gap-1.5">
                            ...
                            <li class="my-3 list-none ">
                                <a class="text-center  textwhite h-[3em] sm:h-p[1.5em] mb-10 sm:mb-0  nav-link"
                                    href="{{ route('login') }}">{{ __('Login') }}</a>
                            </li>

                            <li class="w-full p-3 my-3 bg-slate-600">
                                <a class="text-center text-slate-300 textwhite h-[2.5em] sm:h-p[1.5em] mb-10 sm:mb-0  nav-link"
                        ...
                        <div class="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input id="name" type="text" name="name" required autocomplete="name"
                                                ...
                                                class=" @error('name') is-invalid @enderror w-full py-4 pl-6 pr-10 bg-transparent border rounded-lg outline-none border-stroke focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                            ...
                            <div class="flex justify-center">
                                <input type="submit" value="Create account"
                                    class="w-[90%] p-4 font-medium text-white transition border rounded-lg cursor-pointer border-primary bg-primary hover:bg-opacity-90" />
                               
                            </div> <br>
                                    <div class="flex justify-center">     
                                    
                      <button
                      class="flex w-[90%]  items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 font-medium hover:bg-opacity-70 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-70"
                    >
                      <span>
                        <svg
                          width="20"
