...
{{-- profile --}}
    <div class="flex flex-row profile">
        ...
        <main class="relative right-0 flex justify-center w-full my-5 top-7">
              ...
              <div class="mx-auto max-w-242.5">
                ...
                >
                  <div class="relative z-20 h-35 md:h-65">
                    <img
                      src="{{url('/images/cover/cover-01.png')}}"
                      alt="profile cover"
                      class="object-cover object-center w-full h-full rounded-tl-sm rounded-tr-sm"
                    />
                    <div
                      class="absolute z-10 bottom-1 right-1 xsm:bottom-4 xsm:right-4"
                    >
                  ...
                  <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
                    <div
                      class="relative z-30 w-full p-0 mx-auto rounded-full -mt-22 h-30 max-w-30 bg-white/20 backdrop-blur sm:h-44 sm:max-w-44 "
                    >
                      <div class="relative drop-shadow-">
                        <img class="rounded-full sm:h-44 sm:max-w-44 h-30 max-w-30" src="{{'images/user/' . Auth::user()->img }}" alt="profile" />
                    ...
                    <div class="mt-4">
                      ...
                      <div class="mx-auto max-w-180">
                        ...
                        <p class="bio mt-4.5 text-sm font-normal">
                            {{Auth::user()->bio}}
                        </p>
                      </div>
                        </div>
