...
<body class="bg-gray-100 font-sans text-gray-800">
    ...
    <x-header/>
    <!-- Tools Section -->
    <div class="container mx-auto p-6 pt-[12em]">
    ...
    At [Your Website Name], we offer a variety of user-friendly online tools to simplify your tasks. From downloading videos and editing PDFs to generating CVs and creating short URLs, our tools are designed for efficiency and ease of use. Access them directly from your browser and complete your tasks quickly and effortlessly.
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg hover:scale-105 transform transition-all">
                ...
                <a title='instagram video downloader'     href="{{ url('online-tools/instagram-online-video-downloader') }}" class="block mt-4 text-center text-teal-600 font-semibold hover:underline transition">Use Tool</a>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg hover:scale-105 transform transition-all">
                ...
                <a title='youtube video downloader'    href="{{ url('online-tools/youtube-online-video-downloader') }}" class="block mt-4 text-center text-teal-600 font-semibold hover:underline transition">Use Tool</a>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg hover:scale-105 transform transition-all">
                ...
                <a title='short url generator' href="{{ url('online-tools/short-url') }}" class="block mt-4 text-center text-teal-600 font-semibold hover:underline transition">Use Tool</a>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg hover:scale-105 transform transition-all">
                ...
                <a title='paraphrase' href="{{ url('online-tools/Paraphrase') }}"  class="block mt-4 text-center text-teal-600 font-semibold hover:underline transition">Use Tool</a>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg hover:scale-105 transform transition-all">
                ...
                <a title='cv generator'  href="{{ url('online-tools/CV-generator') }}" class="block mt-4 text-center text-teal-600 font-semibold hover:underline transition">Use Tool</a>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg hover:scale-105 transform transition-all">
                ...
                <a title='online code editor' href="{{ url('online-tools/Online-code-editor') }}" class="block mt-4 text-center text-teal-600 font-semibold hover:underline transition">Use Tool</a>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg hover:scale-105 transform transition-all">
                ...
                <a title='pdf editor' href="{{ url('online-tools/online-pdf-editor') }}" class="block mt-4 text-center text-teal-600 font-semibold hover:underline transition">Use Tool</a>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg hover:scale-105 transform transition-all">
                ...
                <a title='pdf compression'   href="{{ url('online-tools/online-pdf-compressor') }}" class="block mt-4 text-center text-teal-600 font-semibold hover:underline transition">Use Tool</a>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg hover:scale-105 transform transition-all">
                ...
                <a title='pdf to image'   href="{{ url('online-tools/pdf-to-image') }}" class="block mt-4 text-center text-teal-600 font-semibold hover:underline transition">Use Tool</a>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg hover:scale-105 transform transition-all">
                ...
                <a title='html to pdf'   href="{{ url('online-tools/html-to-pdf') }}" class="block mt-4 text-center text-teal-600 font-semibold hover:underline transition">Use Tool</a>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg hover:scale-105 transform transition-all">
                ...
                <a title='image to pdf' href="{{ url('online-tools/image-to-pdf') }}" class="block mt-4 text-center text-teal-600 font-semibold hover:underline transition">Use Tool</a>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg hover:scale-105 transform transition-all">
                ...
                <a title='image compression' href="{{ url('online-tools/online-images-compression') }}" class="block mt-4 text-center text-teal-600 font-semibold hover:underline transition">Use Tool</a>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg hover:scale-105 transform transition-all">
                ...
                <a title='extract text from image' href="{{ url('online-tools/extract-text-from-image') }}" class="block mt-4 text-center text-teal-600 font-semibold hover:underline transition">Use Tool</a>
            </div>
