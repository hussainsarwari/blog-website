...
<body class="overflow-x-hidden">
    ...
    <div class="relative w-full h-screen mb-20 z-[200]">
        <div class="container   p-3 relative top-[20em] m-auto  z-[180] ">
            <h1 class="m-5 font-bold text-center text-blue-800 business_title">Welcome to Our Personal Development <span
                    class="text-yellow-300">

                    Blog
                </span>
            </h1>
            <p class="p-3 m-auto text-center text-blue-950" >Welcome to our personal development blog, where we explore practical strategies and insights to help you unlock your full potential. Join us on a journey of self-discovery as we share tips on goal setting, mindfulness, and building resilience. Together, let’s embrace growth and empower ourselves to live our best lives!</p>
        ...
        <div class="container bg-white shadow-2xl  p-3 relative top-[40em] m-auto   rounded-xl ">
            ...
            <p class="text-center text-slate-400">
                Discover our latest blog posts that delve into exciting personal development topics, from effective goal-setting strategies to enhancing emotional intelligence. Each article is packed with actionable insights and tips to help you thrive in your personal and professional life. Join the conversation and take the first step towards your growth journey today!
            </p>
            ...
            <div class="flex flex-col xl:flex-row">
                ...
                <div
                    ...
                    <a href="{{ url('/blog/Personal-Development/' . 'title') }}"
            ...
            <div class="p-3 flex flex-col  min-h-[50em] sm:min-h-[40em] max-h-[150em]  overflow-y-auto mt-[20em]">
                ...
                <hr>
                {{-- header --}}
                <span class=" italic font-bold text-center text-blue-500  h-[2em] block w-full text-xl">All Personal Development
                    Posts</span>
                <p class="text-center text-slate-400">
                    Explore our wide range of blog posts covering personal development, wellness, and self-improvement. From practical tips on building habits to strategies for achieving work-life balance, each article is designed to inspire growth and positive change. Dive in and discover valuable insights to help you live a more fulfilling and empowered life!
                </p>
                <hr>
                <hr>
                ...
                <div class="p-3  w-full h-fit z-[101] mt-[10em]">
                    ...
                    <a href="{{ url('/blog/Personal-Development/' . 'my name is hussain hahah') }}"
