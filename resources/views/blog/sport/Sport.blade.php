...
<body class="overflow-x-hidden">
    ...
    <div class="relative w-full h-screen mb-20 z-[200]">
        <div class="container   p-3 relative top-[20em] m-auto  z-[180] ">
            <h1 class="m-5 font-bold text-center text-blue-800 business_title">Welcome to Our Sport <span
                    class="text-yellow-300">

                    Blog
                </span>
            </h1>
            <p class="p-3 m-auto text-center text-blue-950" style="font-size: 16px;">Welcome to our sports blog, where we bring you the latest news and insights from the world of sports. Join us as we explore thrilling game highlights, player profiles, and everything that makes sports so exciting!.</p>
        ...
        <div class="container bg-white shadow-2xl  p-3 relative top-[40em] m-auto   rounded-xl ">
            ...
            <p class="text-center text-slate-400">
                Check out our latest articles covering the most exciting developments and trends in the world of sports. From game highlights to in-depth player analyses, we invite you to dive into our engaging content and share your thoughts with us!
            </p>
            ...
            <div class="p-3 flex flex-col  min-h-[50em] sm:min-h-[40em] max-h-[150em]  overflow-y-auto mt-[20em]">
                ...
                <hr>
                {{-- header --}}
                <span class=" italic font-bold text-center text-blue-500  h-[2em] block w-full text-xl">All Sport
                    Posts</span>
                <p class="text-center text-slate-400">
                    Explore our diverse range of blog posts covering various topics in sports, offering insights, trends, and practical advice for fans and athletes alike. Join the conversation and stay updated with our latest articles and discussions!
                </p>
                <hr>
                <hr>
                ...
                <div class="p-3  w-full h-fit z-[101] mt-[10em]">
                    ...
                    <a href="{{ url('/blog/sport/' . 'my name is hussain hahah') }}"
