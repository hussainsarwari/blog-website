...
<body class="overflow-x-hidden">
    ...
    <div class="relative w-full h-screen mb-20 z-[200]">
        <div class="container   p-3 relative top-[20em] m-auto  z-[180] ">
            <h1 class="m-5 font-bold text-center text-blue-800 business_title">Welcome to Our Movie <span
                    class="text-yellow-300">

                    Blog
                </span>
            </h1>
            <p class="p-3 m-auto text-center text-blue-950">Welcome to our movie blog, your go-to place for the latest film reviews, industry news, and cinematic insights! Whether you're a fan of blockbuster hits, indie films, or classic cinema, we’ve got something for every movie lover. Join us as we explore the magic of storytelling on the big screen!</p>
        ...
        <div class="container bg-white shadow-2xl  p-3 relative top-[40em] m-auto   rounded-xl ">
            ...
            <p class="text-center text-slate-400">
                Check out our latest movie blog post, where we review the most talked-about films of the season. From thrilling action-packed blockbusters to heartfelt indie gems, we break down what’s worth watching. Don’t miss our expert insights and recommendations for your next movie night!
            </p>
            ...
            <div class="p-3 flex flex-col  min-h-[50em] sm:min-h-[40em] max-h-[150em]  overflow-y-auto mt-[20em]">
                ...
                <hr>
                {{-- header --}}
                <span class=" italic font-bold text-center text-blue-500  h-[2em] block w-full text-xl">All Movie
                    Posts</span>
                <p class="text-center text-slate-400">
                    Dive into our extensive collection of movie blog posts, where we cover everything from in-depth reviews and analysis to behind-the-scenes insights from the film industry. Whether you're looking for recommendations on the latest releases, classic favorites, or hidden gems, our posts cater to every movie enthusiast. Join us in celebrating the art of cinema and stay updated on trends, director spotlights, and upcoming films!
                </p>
                <hr>
                <hr>
                ...
                <div class="p-3  w-full h-fit z-[101] mt-[10em]">
                    ...
                    <a href="{{ url('/blog/Movie/' . 'my name is hussain hahah') }}"
