...
<body class="overflow-x-hidden">
    ...
    <div class="relative w-full h-screen mb-20 z-[200]">
        <div class="container   p-3 relative top-[20em] m-auto  z-[180] ">
            <h1 class="m-5 font-bold text-center text-blue-800 business_title">Welcome to Our Islamic <span
                    class="text-yellow-300">

                    Blog
                </span>
            </h1>
            <p class="p-3 m-auto text-center text-blue-900">Welcome to our Islamic blog, where we explore the beauty, wisdom, and teachings of Islam. Join us as we share insights on faith, spirituality, and practical guidance for living a life aligned with Islamic values. Together, let’s deepen our understanding and strengthen our connection to Allah (SWT).</p>
        ...
        <div class="container bg-white shadow-2xl  p-3 relative top-[40em] m-auto   rounded-xl ">
            ...
            <p class="text-center text-slate-400">
                Explore our latest Islamic blog posts, where we discuss the profound lessons from the Qur'an and the importance of patience and gratitude in daily life. Learn how to strengthen your connection with Allah (SWT) through prayer, reflection, and good deeds. Stay inspired with practical advice rooted in Islamic teachings for spiritual growth.
            </p>
            ...
            <div class="p-3 flex flex-col  min-h-[50em] sm:min-h-[40em] max-h-[150em]  overflow-y-auto mt-[20em]">
                ...
                <hr>
                {{-- header --}}
                <span class=" italic font-bold text-center text-blue-500  h-[2em] block w-full text-xl">All Islamic
                    Posts</span>
                <p class="text-center text-slate-400">
                ...
                <div class="p-3  w-full h-fit z-[101] mt-[10em]">
                    ...
                    <a href="{{ url('/blog/Islamic/' . 'my name is hussain hahah') }}"
