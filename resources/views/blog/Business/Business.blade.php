...
<body class="overflow-x-hidden">
    ...
    <div class="relative w-full h-screen mb-20 z-[200]">
        ...
        <div class="container bg-white shadow-2xl  p-3 relative top-[50em] m-auto   rounded-xl ">
            ...
            <div
                class="relative flex flex-col justify-center min-h-[50em] sm:min-h-[40em] max-h-[150em]  overflow-y-auto mt-[20em]">
                <hr>
                <hr>
                ...
                <hr>
                    ...
                    <a href="#"
                        class="flex flex-row justify-around p-2 my-4 transition-all duration-100 rounded-md ab hover:underline hover:scale-y-95 bg-slate-50 sm:shadow-xl hover:shadow-2xl relative">

                        {{-- contant --}}
                        <div
                            class="w-full h-[20em] flex flex-col justify-between p-4 sm:relative absolute z-[100] sm:bg-none bg-gradient-to-t from-[#2867a3] to-none backdrop-blur-0 hover:backdrop-blur-sm">
                            <p class="mb-2 text-sm font-semibold text-blue-400 md:text-xl">Post Title

                                <hr>
                            </p>
                            <section>

                                <p class="text-sm text-slate-400">This is a brief description of the large blog post.
                                    It
                                    should
                                    provide an overview of the content, enticing readers to click through and read more.
                                </p>
                        ...
                        {{-- image --}}
                        <div class="image md:relative absolute m-auto w-[100%] h-[20em] md:w-[18em] md:h-[18em]">
                            <img src="{{ url('images/2.jpg') }}" alt="Blog Post"
                                class="absolute object-cover w-full h-full rounded-md">
                        </div>
                    </a>
