...
<body class="overflow-x-hidden">
    ...
    <header class="header-area header-sticky h-[80px] md:h-[140px] " style='z-index:240;'>
    ...
    <div class="relative w-full h-screen mb-20 z-[200]">
        ...
        <div
            class="w-[55em] h-[55em] lg:w-[80em] lg:h-[80em] bg-blue-500 shadow-2xl shadow-blue-600 absolute top-[-18em] right-[5em] rounded-full z-[-1]">
        </div>
