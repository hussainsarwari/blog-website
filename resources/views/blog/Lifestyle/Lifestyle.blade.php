...
<body class="overflow-x-hidden">
    ...
    <div class="relative w-full h-screen mb-20 z-[200]">
        <div class="container   p-3 relative top-[20em] m-auto  z-[180] ">
            <h1 class="m-5 font-bold text-center text-blue-800 business_title">Welcome to Our Lifestyle <span
                    class="text-yellow-300">

                    Blog
                </span>
            </h1>
            <p class="p-3 m-auto text-center text-blue-900">Welcome to our lifestyle blog, where we explore everything from wellness and travel to food and fashion! Join us as we share tips, stories, and inspiration to help you live your best life every day.</p>
        ...
        <div class="container bg-white shadow-2xl  p-3 relative top-[40em] m-auto   rounded-xl ">
            ...
            <p class="text-center text-slate-400">Check out our latest blog posts that explore the vibrant world of lifestyle, covering everything from wellness tips to travel adventures. Join us as we share practical advice and inspiration to help you live your best life!
            </p>
            ...
            <div class="flex flex-col xl:flex-row">
                ...
                <div
                    ...
                    <a href="{{ url('/blog/lifestyle/' . 'title') }}"
            ...
            <div class="p-3 flex flex-col  min-h-[50em] sm:min-h-[40em] max-h-[150em]  overflow-y-auto mt-[20em]">
                ...
                <hr>
                {{-- header --}}
                <span class=" italic font-bold text-center text-blue-500  h-[2em] block w-full text-xl">All Lifestyle
                    Posts</span>
                <p class="text-center text-slate-400">Explore our collection of lifestyle blog posts that cover a wide range of topics, from health and wellness to travel and personal development. Each article is designed to inspire and inform, offering practical tips and insights for enhancing your daily life. Join our community and discover ways to elevate your lifestyle and embrace new experiences!
                </p>
                <hr>
                <hr>
                ...
                <div class="p-3  w-full h-fit z-[101] mt-[10em]">
                    ...
                    <a href="{{ url('/blog/lifestyle/' . 'my name is hussain hahah') }}"
