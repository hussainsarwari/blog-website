...
<head>
    ...
    <script type="module" src="{{asset('js/apexchart.js')}}"></script>
   ...
   ></div>
    ...
    <header class="sticky top-0 flex w-full bg-white z-999 drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
        <div class="flex items-center justify-between flex-grow px-4 py-4 shadow-2 md:px-6 2xl:px-11">
            ...
            <div class="flex justify-between w-full gap-3 2xsm:gap-7">
                <h4 class='hidden text-md header-item sm:text-lg'>Time management system</h4>
                <ul class="absolute flex items-center gap-2 top-2 right-4 header-item 2xsm:gap-4">
                    ...
                    <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                        <a class="flex items-center gap-4" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
                            <span class="hidden text-right lg:block">
                                ...
                                <span class="w-12 h-12 rounded-full">
                                    <img class="w-12 h-12 rounded-full" src="{{'images/user/' . Auth::user()->img }}" alt="User" />
                                </span>
                        ...
                        <div x-show="dropdownOpen"
                            ...
                            <button
                                ...
                                <a class="dropdown-item" class="logout-btn" href="{{ route('logout') }}"
