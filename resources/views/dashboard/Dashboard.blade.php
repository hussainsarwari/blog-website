...
<style>
    ...
    {{-- dashboard --}}
    <div class="flex flex-row dashboard">

        <aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
            class="fixed left-0 top-0 z-[100] flex h-screen w-80 flex-col  bg-slate-200 duration-300 ease-linear dark:bg-boxdark lg:translate-x-0"
        ...
        <main class="absolute right-0 flex justify-center w-full my-5 CHART top-7">
                        ...
                        <div class="flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap">
                            <div class="flex flex-wrap w-full gap-3 sm:gap-5">
                                <div class="flex min-w-47.5">
                                    ...
                                    <div class="w-full">
                                        <p class="font-semibold text-primary">Last week</p>
                                    </div>
                                </div>
                                <div class="flex min-w-47.5">
                                    <span
                                    ...
                                    <div class="w-full">
                                        <p class="font-semibold text-secondary">This week</p>
                                    </div>
                                </div>
                            </div>
